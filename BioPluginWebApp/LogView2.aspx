<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogView2.aspx.cs" Inherits="BioPluginWebApp_LogView2" %>
...
&nbsp;&nbsp; TO&nbsp;&nbsp;
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("SELECT  Name,Emp_No,Company,Meal_Ticket,Old,New,AdmAdd,D,AdmApp,D1,Status FROM MealCat where DD  >= '" + (Session["DD"].ToString()) + "' and DD1 <= '" + (Session["DD1"].ToString()) + "'  ORDER BY D,Company,Name ASC", dbConn);
