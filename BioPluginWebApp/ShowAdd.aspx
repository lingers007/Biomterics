<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowAdd.aspx.cs" Inherits="BioPluginWebApp_ShowAdd" %>
...
<head id="Head1" runat="server">
    <title>Pending Ticket To Be Added</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
        ...
        <table border="1" style="width: 710px; font-size: 14px;">
            <tr>
                <td class="style27" 
                    ...
                    style="font-size: 13px; font-weight: bold; font-family: candara; background-color: #0099CC;">
                    Name</td>
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id,Company,Name,Emp_No,Operation,Meal_Ticket from Temp where Operation='Addition' and Status='Pending'", dbConn);
                            ...
                            while (sdz.Read())
                            {
                                ...
                                Response.Write("<tr style><td class='style2'>" + sdz["Name"].ToString() + "</td><td class='style2'>" + sdz["Company"].ToString() + "</td><td class='style2'>" + sdz["Emp_No"].ToString() + "</td><td>" + sdz["Meal_Ticket"].ToString() + "</td><td class='style5'><a href='Addition.aspx?id=" + sdz["id"].ToString() + "'>Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;  <a href='Delete.aspx?id=" + sdz["id"].ToString() + "'>Decline</a> </td></tr>");
                                ct++;
