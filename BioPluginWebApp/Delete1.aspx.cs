...
public partial class BioPluginWebApp_Delete1 : System.Web.UI.Page
{
    string selectSQL;
    string selectSQL3;
    string selectSQL23;
...
try
        ...
        var ttt1 = DateTime.Parse(Session["TT1"].ToString(), dateFormatProvider);


        updateSQL2 = "update Temp set  Status='Declined',AdmApp='" + Session["username"] + "',D1='" + ttt1 + "'  where id='" + Session["id"] + "' and Emp_No='" + Session["Empp"] + "' and Company='" + Session["Com"] + "'    ";
