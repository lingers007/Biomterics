<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubProb.aspx.cs" Inherits="BioPluginWebApp_SubProb" %>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            <td align="center" class="style4" 
                ...
                <br />
                <br />
                        The staff Does Not Exist or the Request for the Added Ticket has been 
                    Deleted.<br />
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="ShowSub.aspx">Return 
