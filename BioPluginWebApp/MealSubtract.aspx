<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MealSubtract.aspx.cs" Inherits="BioPluginWebApp_MealSubtract" %>
...
<body>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        ...
        <legend style="font-family: Arial; font-size: small; font-weight: normal; font-style: normal">
            <b style="font-size: normal;">Subtract Individual Meal Ticket </legend>
            ...
            <b style="font-size: normal; ">
                                ...
                                <tr>
                                    <td class="style24" align="left">
                                        Enter Number of Ticket To Deduct</td>
                                    <td class="style21">
            ...
            <b style="font-size: normal; ">
                                ...
                                <tr>
                                    <td class="style24" align="left">
            <b style="font-size: normal;">Reason For Subtraction</b></td>
                                    <td class="style21">
            <b style="font-size: normal;">
                                ...
                                <tr>
                                    ...
                                    <td class="style26">
                                        <asp:Button ID="Button1" runat="server" OnClick="OnConfirm" OnClientClick="Confirm()"
                                            Text="Subtract Meal Ticket" Width="154px" />
