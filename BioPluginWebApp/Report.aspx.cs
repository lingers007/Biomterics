...
public partial class BioPluginWebApp_Report : System.Web.UI.Page
{
    string selectSQL;
    string updateSQL;
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        selectSQL = "select * from MealLog where Time1  >=  '" + RadDatePicker1.SelectedDate.Value.ToShortDateString() + "' and  Time1 <= '" + RadDatePicker2.SelectedDate.Value.ToShortDateString() + "'  ";
