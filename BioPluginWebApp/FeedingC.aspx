<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FeedingC.aspx.cs" Inherits="BioPluginWebApp_FeedingC" %>
...
<head id="Head1" runat="server">
    <title>Change Feeding Confirmation</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            <td align="center" class="style4" 
                ...
                <br />
                <br />
                You Have Succesfully Requested For Updating of EmPloyee With Emp.No<asp:Label 
                    ID="Label1" runat="server" Width="89px" ForeColor="#009933"></asp:Label>
&nbsp; &nbsp;&nbsp; from Meal Category
                <asp:Label ID="Label2" runat="server" 
                    Width="37px" ForeColor="#009933"></asp:Label> to 
                <asp:Label ID="Label3" runat="server" 
                    Width="40px" ForeColor="#009933"></asp:Label>
