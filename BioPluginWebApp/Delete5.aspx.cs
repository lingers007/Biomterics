...
public partial class BioPluginWebApp_Delete : System.Web.UI.Page
{
    string selectSQL;
    string selectSQL3;
    string selectSQL23;
...
try
        ...
        updateSQL2 = "update MealCat set  Status='Declined',AdmApp='" + Session["username"] + "',D1='" + ttt5 + "'  where id='" + Session["id"] + "' and Emp_No='" + Session["Empp"] + "' and Company='" + Session["Com"] + "'    ";
