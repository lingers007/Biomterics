<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BioProb.aspx.cs" Inherits="BioPluginWebApp_BioProb" %>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            <td align="center" class="style4" 
                    ...
                    <tr>
                        <td style="background-color: #006699" class="style5" align="right">
                                                          <asp:LinkButton ID="LinkButton4" runat="server" ForeColor="White" 
                                                             ...
                                                             ID="LinkButton5" runat="server" ForeColor="White" 
                ...
                <br />
                <br />
                        Biometric&nbsp; Enrollment Failed                     <br />
                    ((Either The Finger Print&nbsp; Exist or ID already Exist In The Database).<br />
                    <br />
                    <br />
                    <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="White" 
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="White" 
                                                              PostBackUrl="H1.aspx">Home</asp:LinkButton>
                    <br />
                    <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="LginF.aspx">Return 
