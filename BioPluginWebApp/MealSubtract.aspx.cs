...
public partial class BioPluginWebApp_MealSubtract : System.Web.UI.Page
{
...
try
    ...
    protected void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            int z = Convert.ToInt32(Session["D"]);
            int y = x - z;
                ...
                var tt9 = DateTime.Parse(Session["T"].ToString(), dateFormatProvider);


                DateTimeFormatInfo dateFormatProvider1 = new DateTimeFormatInfo();
                dateFormatProvider1.ShortDatePattern = "yyyy-MM-dd";
                var tt99 = DateTime.Parse(Session["T"].ToString(), dateFormatProvider);
                ...
                try
                {
                    ...
                    if (added == 1)
                    {
                        Response.Redirect("SubtractC.aspx");
