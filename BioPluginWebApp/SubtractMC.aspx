<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SubtractMC.aspx.cs" Inherits="BioPluginWebApp_SubtractMC" %>

<head id="Head1" runat="server">
    <title>Subtract Monthly Meal Ticket Confirmation</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
