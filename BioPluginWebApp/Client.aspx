...
<head id="Head1" runat="server">
    <title>AR Packaging Workers Biometric Login Page</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            <td align="center" class="style4" 
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                AR PACKAGING CANTEEN BIOMETRIC SYSTEMS<br />
                <br />
                ...
                <br />
                <br />
                <img src="Images/16.jpg" style="width: 200px; height: 200px" /><br />
                <br />
                <br />
            ...
            <tr>
                ...
                <table cellpadding="3px" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="100px">
                            <asp:Button ID="btnIdentify" runat="server" Text="Verify" Enabled="false" 
