<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogVV1.aspx.cs" Inherits="BioPluginWebApp_LogVV1" %>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            <td align="center" class="style4" 
                ...
                <br />
                <br />
                        LOG&nbsp; REPORT FOR&nbsp;&nbsp;SUBTRACTION OPERATION
&nbsp;OF&nbsp; MEAL TICKET&nbsp; FROM&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp; TO&nbsp;&nbsp;
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("SELECT  Name,Emp_No,Company,Meal_Ticket,Reason,AdmAdd,D,AdmApp,D1,Status FROM Temp where DD  >= '" + (Session["DD"].ToString()) + "' and DD1 <= '" + (Session["DD1"].ToString()) + "' and Operation='SUBTRACTION' and Emp_No='" + Session["C"].ToString() + "' ORDER BY D,Company,Name ASC", dbConn);
