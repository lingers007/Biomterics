<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detailed.aspx.cs" Inherits="BioPluginWebApp_Detailed" %>
                            ...
                            <tr>
                                ...
                                <td class="style15">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                        ControlToValidate="RadDatePicker2" ErrorMessage="Enter Start Date"></asp:RequiredFieldValidator>
                                    </td>
                                <td class="style15">
