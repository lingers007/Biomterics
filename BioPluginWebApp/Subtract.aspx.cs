...
public partial class BioPluginWebApp_Subtract : System.Web.UI.Page
{
    string selectSQL;
    string selectSQL3;
    string selectSQL23;
...
try
        ...
        try
        {
            ...
            else
            {
                ...
                Response.Redirect("SubProb1.aspx");
        ...
        try
        {
            ...
            if (updated2 == 1)
            {
                ...
                var tt4 = DateTime.Parse(Session["T2"].ToString(), dateFormatProvider);


                DateTimeFormatInfo dateFormatProvider1 = new DateTimeFormatInfo();
                dateFormatProvider1.ShortDatePattern = "yyyy-MM-dd";
                var tt44 = DateTime.Parse(Session["T2"].ToString(), dateFormatProvider);

                updateSQL2 = "update Temp set  Status='Approved',AdmApp='" + Session["username"] + "',D1='" + tt4 + "',DD1='" + tt44 + "'  where id='" + Session["id"] + "' and Emp_No='" + Session["Empp"] + "' and Company='" + Session["Com"] + "'    ";
