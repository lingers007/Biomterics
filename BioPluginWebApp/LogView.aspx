<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogView.aspx.cs" Inherits="BioPluginWebApp_LogView" %>
...
&nbsp;&nbsp; TO&nbsp;&nbsp;
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("SELECT  Name,Emp_No,Company,Meal_Ticket,Reason,AdmAdd,D,AdmApp,D1,Status FROM Temp where DD  >= '" + (Session["DD"].ToString()) + "' and DD1 <= '" + (Session["DD1"].ToString()) + "' and Operation='Addition' ORDER BY D,Company,Name ASC", dbConn);
