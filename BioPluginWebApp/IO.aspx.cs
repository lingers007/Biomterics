...
public partial class BioPluginWebApp_IO : System.Web.UI.Page
{
...
try
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        Session["O"] = DropDownList1.SelectedItem.Text;
        ...
        if (DropDownList1.SelectedItem.Text == "ADDED TICKET")
        {
            ...
            selectSQL = "select * from Temp where DD  >=  '" + RadDatePicker1.SelectedDate.Value.ToShortDateString() + "' and DD1 <='" + RadDatePicker2.SelectedDate.Value.ToShortDateString() + "' and Operation='" + DropDownList1.SelectedItem.Value + "' and Emp_No='" + TextBox2.Text.Trim() + "'  ";
        ...
        {
            selectSQL = "select * from MealCat where DD  >=  '" + RadDatePicker1.SelectedDate.Value.ToShortDateString() + "' and DD1 <= '" + RadDatePicker2.SelectedDate.Value.ToShortDateString() + "'  and Emp_No='" + TextBox2.Text.Trim() + "'  ";
            dbConn.ConnectionString = "Data Source=GROKL\\MEALTICKET; Initial Catalog=KAGING;User ID=Mticket;password=Meal2&#*@2%;Integrated Security=False;Max Pool Size=200;";
            cmd.Connection = dbConn;
            cmd.CommandText = selectSQL;
            cmd.CommandType = CommandType.Text;
        ...
        {
            selectSQL = "select * from List_1 where DD  >=  '" + RadDatePicker1.SelectedDate.Value.ToShortDateString() + "' and DD1 <= '" + RadDatePicker2.SelectedDate.Value.ToShortDateString() + "' and Emp_No='" + TextBox2.Text.Trim() + "'  ";
            dbConn.ConnectionString = "Data Source=GROKL\\MEALTICKET; Initial Catalog=KAGING;User ID=Mticket;password=Meal2&#*@2%;Integrated Security=False;Max Pool Size=200;";
            cmd.Connection = dbConn;
            cmd.CommandText = selectSQL;
            cmd.CommandType = CommandType.Text;
